...
public class Activity_Thtin4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thtin4);
        context = this;

        listView = (ListView) findViewById(R.id.lv4);
        buttonAdd = (Button) findViewById(R.id.btnAdd4);
        editText = (EditText) findViewById(R.id.edt4);
        buttonUpdate = (Button) findViewById(R.id.btnUp4);
        buttonQl = (Button) findViewById(R.id.btnE);

        listData = new ArrayList<>();
        listData.add("Tên: Võ Trần Anh Khoa");
        listData.add("Năm sinh: 2000");
        listData.add("Địa chỉ: Hòa Khánh Nam, Đà Nẵng");
        listData.add("Đơn vị làm việc: Quản lý hệ thống TKBN ");
        ...
        buttonQl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(Activity_Thtin4.this, ActivityThongtin.class);
