...
public class Activity_Thtin1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thtin1);
        context = this;
        ...
        listData.add("Tên: Nguyễn Văn A");
        listData.add("Năm sinh: 1985");
        listData.add("Địa chỉ: Hòa Khánh Nam, Đà Nẵng");
        listData.add("Đơn vị làm việc: Tài xế lái xe chở hàng");
        listData.add("Số đơn hàng đã chở: 15");
        listData.add("Hiện đang chở hàng: Có");
        listData.add("Số điểm đánh giá tháng 12: " + MainActivity4.diemDGia);
        listData.add("Số điểm đánh giá tháng 1: " + MainActivity3.diemDGia2);
        ...
        buttonQl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(Activity_Thtin1.this, ActivityThongtin.class);
