...
public class Activity_Thtin2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thtin2);
        context = this;
        ...
        buttonUpdate = (Button) findViewById(R.id.btnUp2);
        buttonQl = (Button) findViewById(R.id.btnE);

        listData = new ArrayList<>();
        listData.add("Tên: Đào Thị Thúy Ngân");
        ...
        buttonQl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(Activity_Thtin2.this, ActivityThongtin.class);
